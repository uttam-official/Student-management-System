...
$q="select*from student where name='$name' && roll='$roll' && branch='$branch'";
...
<table border="solid" color="red" style="border:solid ; border-color:red" >
<tr>
<th >STUDENT ID</th>
<th>STUDENT NAME</th>
<th>ROLL NO.</th>
...
To Exit or Logged Out Please  <a href="http://localhost:8080/staff/staffsignout.php"><button>click here</button></a><br/>
